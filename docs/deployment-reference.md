...
Quick reference for deploying Family Quiplash to Digital Ocean.

For a step-by-step walkthrough, see [deployment-walkthrough.md](./deployment-walkthrough.md).

## Prerequisites

- Digital Ocean account
- SSH key added (see [ssh-keys.md](./ssh-keys.md))
...
### 3. Create a Deploy User (Optional)
...
sudo chown $USER:$USER family-quiplash
cd family-quiplash
...
| Resource | Cost |
|----------|------|
| Basic Droplet (1GB RAM) | $6/mo |
| Regular Droplet (2GB RAM) | $12/mo |
| Domain | ~$10-15/year |
| **Total** | **~$7-15/month** |

- **Basic Droplet**: Good for 20-30 concurrent players
- **Regular Droplet**: Better for 50+ concurrent players
